...
namespace HUTOPS
{
    ...
    public partial class HUTOPSEntities : DbContext
    {
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("WEB_GetAll");
        }
    
        public virtual int WEB_GetBoards()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("WEB_GetBoards");
        }
    
        public virtual int WEB_GetGroups(Nullable<int> boardId)
        {
            var boardIdParameter = boardId.HasValue ?
                new ObjectParameter("BoardId", boardId) :
                new ObjectParameter("BoardId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("WEB_GetGroups", boardIdParameter);
        }
    
        public virtual int WEB_GetSubjects(Nullable<int> groupId)
        {
            var groupIdParameter = groupId.HasValue ?
                new ObjectParameter("GroupId", groupId) :
                new ObjectParameter("GroupId", typeof(int));
